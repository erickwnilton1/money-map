/*
  ...
  - The values [Trasportation] on the enum `TransactionCategory` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TransactionCategory_new" AS ENUM ('Food', 'Health', 'Housing', 'Utility', 'Salary', 'Transportation', 'Entertainment', 'Education', 'Other');
